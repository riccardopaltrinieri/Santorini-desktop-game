...
public class PlayerTest {
    ...
    public void canMoveTest() {
        ...
        foo1.placeWorkers(0,0);
        foo1.placeWorkers(1,0);
        foo2.placeWorkers(0,1);
        foo2.placeWorkers(2,0);
        foo3.placeWorkers(0,2);
        foo3.placeWorkers(1,2);
        foo4.placeWorkers(2,1);
